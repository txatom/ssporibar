...
$from_emailaddress = "ssporibar@ssporibar.org";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "dedar.mithu@gmail.com";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "dedar.mithu@gmail.com"; // your email address to send backup files to
